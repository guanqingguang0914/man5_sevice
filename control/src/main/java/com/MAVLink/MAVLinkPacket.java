...
import com.abilix.control.uav.MAVLinkDataProcess;
import com.abilix.control.utils.LogMgr;
import com.abilix.control.uav.DataBuffer;
import com.abilix.control.uav.DataProcess;
import com.abilix.control.uav.MAVLinkObj;
...
public class MAVLinkPacket implements Serializable {
    ...
    public byte[] encodePacket() {
        ...
        buffer[i++] = (byte) len;
        buffer[i++] = (byte) (seq = MAVLinkDataProcess.mavlink_seq++);
        buffer[i++] = (byte) sysid;
    ...
    public MAVLinkMessage unpack() {//
        if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  " + msgid);
        switch (msgid) {
            ...
            case msg_ahrs.MAVLINK_MSG_ID_AHRS:
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  163  ahrs");
                return (MAVLinkObj.ahrs = new msg_ahrs(this));//163
            ...
            case msg_rangefinder.MAVLINK_MSG_ID_RANGEFINDER://173
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  173  rangefinder");
                return (MAVLinkObj.rangefinder = new msg_rangefinder(this));
            ...
            case msg_ahrs2.MAVLINK_MSG_ID_AHRS2:
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  178  ahrs2");
                return (MAVLinkObj.ahrs2 = new msg_ahrs2(this));//178
            ...
            case msg_battery2.MAVLINK_MSG_ID_BATTERY2://181
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  181  battery2");
                return new msg_battery2(this);


            case msg_heartbeat.MAVLINK_MSG_ID_HEARTBEAT://0
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  0   心跳 HEARTBEAT");
                return (MAVLinkObj.heartbeat = new msg_heartbeat(this));
            case msg_sys_status.MAVLINK_MSG_ID_SYS_STATUS:
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  1   心跳");
                return (MAVLinkObj.sys_status = new msg_sys_status(this));//1
            case msg_system_time.MAVLINK_MSG_ID_SYSTEM_TIME:
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  2  system_time");
                return (MAVLinkObj.system_time = new msg_system_time(this));//2
            ...
            case msg_gps_raw_int.MAVLINK_MSG_ID_GPS_RAW_INT:
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  24  gps_raw");
                return (MAVLinkObj.gps_raw_int = new msg_gps_raw_int(this));//24
            ...
            case msg_raw_imu.MAVLINK_MSG_ID_RAW_IMU:
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  27  raw_imu");
                return (MAVLinkObj.raw_imu = new msg_raw_imu(this));//27
            case msg_raw_pressure.MAVLINK_MSG_ID_RAW_PRESSURE:
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  28  raw_pressure");
                return (MAVLinkObj.raw_pressure = new msg_raw_pressure(this));//28
            case msg_scaled_pressure.MAVLINK_MSG_ID_SCALED_PRESSURE:
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  29  scaled_pressure");
                return (MAVLinkObj.scaled_pressure = new msg_scaled_pressure(this));//29
            case msg_attitude.MAVLINK_MSG_ID_ATTITUDE:
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  30  attitude");
                return (MAVLinkObj.attitude = new msg_attitude(this));//30
            case msg_attitude_quaternion.MAVLINK_MSG_ID_ATTITUDE_QUATERNION:
                return new msg_attitude_quaternion(this);
            case msg_local_position_ned.MAVLINK_MSG_ID_LOCAL_POSITION_NED://32
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  32  local_position_ned");
                return new msg_local_position_ned(this);
            case msg_global_position_int.MAVLINK_MSG_ID_GLOBAL_POSITION_INT:
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  33  global_position");
                return (MAVLinkObj.global_position_int = new msg_global_position_int(this));//33
            ...
            case msg_servo_output_raw.MAVLINK_MSG_ID_SERVO_OUTPUT_RAW://36
            ...
            case msg_nav_controller_output.MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT:
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  62  nav_controller");
                return (MAVLinkObj.nav_controller_output = new msg_nav_controller_output(this));//62
            ...
            case msg_rc_channels.MAVLINK_MSG_ID_RC_CHANNELS://65
            ...
            case msg_command_ack.MAVLINK_MSG_ID_COMMAND_ACK:
                if (MAVLinkDataProcess.showGetMavlink) LogMgr.i("MAVLinkPacket 接收  77  command_ack");
                return (MAVLinkObj.command_ack = new msg_command_ack(this));//77
            ...
            case msg_attitude_target.MAVLINK_MSG_ID_ATTITUDE_TARGET://83
            ...
            case msg_highres_imu.MAVLINK_MSG_ID_HIGHRES_IMU://105
                return (MAVLinkObj.highres_imu = new msg_highres_imu(this));
            case msg_optical_flow_rad.MAVLINK_MSG_ID_OPTICAL_FLOW_RAD://106
                return (MAVLinkObj.optical_flow_rad = new msg_optical_flow_rad(this));
//            case msg_omnidirectional_flow.MAVLINK_MSG_ID_OMNIDIRECTIONAL_FLOW:
//                return new msg_omnidirectional_flow(this);//106
