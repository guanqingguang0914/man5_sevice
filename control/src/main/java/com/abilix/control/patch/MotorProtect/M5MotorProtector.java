...
public class M5MotorProtector extends AbstractMotorProtector {
    public M5MotorProtector() {
        heartBeatOutCmd1 = GlobalConfig.M_STM32_HEART_BEAT_OUT_CMD_1;
        heartBeatOutCmd2 = GlobalConfig.M_STM32_HEART_BEAT_OUT_CMD_2;
        heartBeatInCmd1 = GlobalConfig.M_STM32_HEART_BEAT_IN_CMD_1;
        heartBeatInCmd2 = GlobalConfig.M_STM32_HEART_BEAT_IN_CMD_2;
        relieveProtectOutCmd1 = GlobalConfig.M_STM32_RELIEVE_PROTECT_OUT_CMD_1;
        relieveProtectOutCmd2 = GlobalConfig.M_STM32_RELIEVE_PROTECT_OUT_CMD_2;
