...
import com.abilix.control.patch.MotorProtect.AbstractMotorProtector;
import com.abilix.control.patch.MotorProtect.IMotorProtect;
import com.abilix.control.patch.MotorProtect.M5MotorProtector;
import com.abilix.control.utils.LogMgr;

public class MPatchDisposer extends AbstractPatchDisposer {
    ...
    public MPatchDisposer(Handler mHandler) {
        super(mHandler);
        mMotorProtector = new M5MotorProtector();
    }
