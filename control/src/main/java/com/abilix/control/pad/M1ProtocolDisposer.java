...
public class M1ProtocolDisposer extends AbstractProtocolDisposer {
    private BalanceCarData balancecarData = null;

    public M1ProtocolDisposer(Handler handler) {
        super(handler);
    }
...
//							returnToClient(returnData);
                    ...
                    if (mSensor.getmO() != null && mSensor.getmG() != null && mSensor.getmS() != null) {
                        ...
                        byte[] responseBytes = ProtocolBuilder.buildProtocol((byte) ControlInitiator.ROBOT_TYPE_M1, ProtocolBuilder.CMD_GYRO, datas);
